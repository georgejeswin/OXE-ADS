        ...
        <div className="services">
            ...
            <h4 className="service-text">WHAT WE OFFER</h4>
             <h1 className="service-head">Our Services</h1>
                    ...
                    <Link to="/" className="btn active" ><span>Learn More</span><i class="fas fa-angle-right"></i></Link>
                </div>
                <div className="service-card">
                    <div className="circle">
                    ...
                    <h2>Branding & Advertising</h2>
                    <Link to="/" className="btn "><span>Learn More</span><i class="fas fa-angle-right"></i></Link>
                </div>
                <div className="service-card">
                    <div className="circle">
